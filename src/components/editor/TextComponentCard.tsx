...
import { User as UserIcon, MessageSquare, Star, CheckCircle, Trash2, ArrowUpRight, Send } from "lucide-react";
...
export function TextComponentCard({ component, currentUserId, isManager }: { 
    ...
    return (
        <div className={`p-4 bg-white rounded-lg border shadow-sm transition-all ${component.status === 'ACCEPTED' ? 'border-green-200 bg-green-50/30' : 'border-slate-200'}`}>
